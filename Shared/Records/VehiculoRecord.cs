...
public class VehiculoRecord
{
    ...
    public VehiculoRecord(int id, string marca, int año, string modelo, string color, string numeroPlaca, decimal precioPorDia, bool si, bool no, bool aireAcondicionado, bool encendedor, bool radio, bool bateria, bool limpiabrisas, bool revista, bool documentos, bool micas, bool asientos, bool gomaRepuesto, bool placa, bool vidrios, bool llaveros, bool antenas, bool gatos, bool tapaGasolina, bool cinturones, bool llaveDeRuedas, bool alfombras, bool espejos, bool tapaDeBocinas, bool bocinas, bool logos )
    {
        Id = id;
        Marca = marca;
        Año = año;
